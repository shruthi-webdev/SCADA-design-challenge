...
export const TopBar: React.FC<TopBarProps> = ({ title, subtitle, isDark = false, onToggleTheme, onNavigateSettings }) => {
    ...
    return (
        <header className="topbar">
            <div className="topbar-left">
                ...
                <button className="topbar-settings-btn" aria-label="Settings" onClick={onNavigateSettings}>
